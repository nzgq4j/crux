...
| REQ-PRV-001 | Provenance | 16 | Nine `knowledge` tables exist; nine claim types are enforced by constraint. | Must | Not started | — | — | — | |
...
| REQ-CIT-002 | Citations | 17 | Citation export works in plain text, APA, Chicago, Harvard, MLA, BibTeX, RIS, and CSL-JSON. | Must | Not started | — | — | — | Final completion control 7 |
...
| REQ-DEP-002 | Deployment | 23 | Backup, restore, and rollback are implemented and rehearsed, with recovery time recorded. | Must | Not started | — | — | — | Final completion control 10 |
